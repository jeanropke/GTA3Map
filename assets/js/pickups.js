class Pickup {
  static init() {
    ...
    return Loader.promises['pickups'].consumeJson(data => {
      ...
      console.info('%c[Pickups] Loaded!', 'color: #bada55; background: #242424');
    });
  }
  ...
  static onLanguageChanged() {
    Pickup.locations.forEach(location => location.onLanguageChanged());
  }

  static onSettingsChanged() {
    Pickup.locations.forEach(location => location.reinitMarker());
  }
}
